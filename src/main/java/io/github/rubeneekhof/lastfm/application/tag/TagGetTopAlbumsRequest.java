...
public record TagGetTopAlbumsRequest(String tag, Integer page, Integer limit) {
  ...
  public static class Builder {
    ...
    public TagGetTopAlbumsRequest build() {
      if (tag == null) {
        throw new IllegalArgumentException("Tag must be provided");
      }
      return new TagGetTopAlbumsRequest(tag, page, limit);
    }
  }
}
