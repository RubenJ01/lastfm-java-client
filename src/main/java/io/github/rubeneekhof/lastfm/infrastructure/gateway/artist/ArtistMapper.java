...
/**
 * Maps Last.fm API DTOs to domain models. This is the only class allowed to access DTO internals.
...
public class ArtistMapper {
  ...
  /**
   * Maps nested similar artists from getInfo response. Returns minimal artist data (name, mbid, url
   * only).
   */
