...
/**
 * Infrastructure-level exception for Last.fm API errors.
 * Contains the numeric error code returned by the API.
 * This should not leak to domain/application layers - use LastFmFailure instead.
 */
